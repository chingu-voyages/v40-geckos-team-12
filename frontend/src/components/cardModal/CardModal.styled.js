...
export const StyledCheckbox = styled.div`
  ...
  background: ${(props) =>
    props.checkActive ? props.theme.fontColorHover : props.theme.main};
  background-image: ${(props) =>
    props.checkActive ? `url(${iconCheck})` : "none"};
...
export const LabelText = styled.span`
  color: ${(props) =>
    props.checkActive ? props.theme.secondFontColor : props.theme.fontColor};
  font-size: 13px;
  width: 100%;
